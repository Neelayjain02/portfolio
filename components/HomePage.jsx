...
const projects = [
  {
    ...
    href: "/lnt_report", // Links to the separate report page
    isReport: true, // Flag to open in new tab
  },
  {
    id: 2,
    ...
    href: "/projects#cawt", // Deep link to project card
  },
  {
    id: 3,
    ...
    href: "/projects#bearing-ai", // Deep link to project card
  },
  {
    id: 4,
    ...
    href: "/projects#spectra", // Deep link to project card
  },
];
...
export default function HomePage() {
  ...
  return (
    <main className="w-full h-screen bg-[#000000] p-2 md:p-6 overflow-hidden flex items-center justify-center font-sans selection:bg-[#FFA500] selection:text-black">
      ...
      {/* INNER CARD */}
      <div className="relative w-full h-full max-w-[1600px] bg-[#0A0A0A] rounded-[40px] border border-white/5 overflow-hidden flex flex-col shadow-2xl z-20">

        {/* --- BACKGROUND FX --- */}
        <div className="absolute inset-0 z-0 pointer-events-none opacity-[0.15]"
          style={{ backgroundImage: "linear-gradient(#333 1px, transparent 1px), linear-gradient(90deg, #333 1px, transparent 1px)", backgroundSize: "40px 40px" }}
        />
        <div className="absolute top-[-10%] left-[20%] w-[500px] h-[500px] bg-[#FFA500]/7 rounded-full blur-[120px] pointer-events-none" />
        <div className="absolute bottom-[-20%] right-[10%] w-[420px] h-[420px] bg-[#FFA500]/4 rounded-full blur-[130px] pointer-events-none" />
        ...
        <motion.div
          ...
          className="flex justify-between items-center w-full px-8 md:px-12 pt-8 md:pt-10 z-20 shrink-0"
        >
          {/* ABOUT BUTTON */}
          <Link href="/about" className="group relative px-6 py-2.5 bg-[#111] rounded-full border border-white/10 overflow-hidden transition-all hover:border-[#FFA500]/50 hover:shadow-[0_0_20px_rgba(255,165,0,0.3)] cursor-pointer z-40">
            ...
            <span className="relative z-10 flex items-center gap-2 text-[11px] font-bold tracking-[0.2em] text-gray-400 group-hover:text-black transition-colors">
          ...
          {/* PROJECTS BUTTON */}
          <Link href="/projects" className="group relative px-6 py-2.5 bg-[#111] rounded-full border border-white/10 overflow-hidden transition-all hover:border-[#FFA500]/50 hover:shadow-[0_0_20px_rgba(255,165,0,0.3)] cursor-pointer z-40">
            <div className="absolute inset-0 bg-[#FFA500] translate-y-[101%] group-hover:translate-y-0 transition-transform duration-300 ease-[cubic-bezier(0.23,1,0.32,1)]" />
            <span className="relative z-10 flex items-center gap-2 text-[11px] font-bold tracking-[0.2em] text-gray-400 group-hover:text-black transition-colors">
              ALL PROJECTS <ArrowRight size={14} className="-rotate-45 group-hover:rotate-0 transition-transform duration-300" />
            </span>
          </Link>
        </motion.div>
        ...
        <motion.div
          ...
          initial="hidden"
          animate="visible"
          className="flex-1 w-full grid grid-cols-1 lg:grid-cols-12 gap-6 px-8 md:px-12 pb-8 items-center relative z-10"
        >
          {/* === LEFT COLUMN === */}
          <div className="lg:col-span-3 flex flex-col justify-center h-full gap-6 order-2 lg:order-1">
            ...
            <motion.div variants={itemAnim} className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-bold text-white tracking-wide">Precision Intelligence</h2>
            ...
            <motion.div variants={itemAnim} className="flex gap-3 z-40">
              <a href="https://www.linkedin.com/in/neelayjain02" target="_blank" rel="noreferrer" className="w-12 h-12 rounded-xl bg-[#111] border border-white/5 flex items-center justify-center text-gray-500 hover:text-[#FFA500] hover:border-[#FFA500]/50 hover:bg-[#FFA500]/5 transition-all">
                <Linkedin size={20} />
              </a>
              <a href="https://github.com/Neelayjain02" target="_blank" rel="noreferrer" className="w-12 h-12 rounded-xl bg-[#111] border border-white/5 flex items-center justify-center text-gray-500 hover:text-[#FFA500] hover:border-[#FFA500]/50 hover:bg-[#FFA500]/5 transition-all">
                <Github size={20} />
              </a>
              <a href="mailto:neelayjain957@gmail.com" className="w-12 h-12 rounded-xl bg-[#111] border border-white/5 flex items-center justify-center text-gray-500 hover:text-[#FFA500] hover:border-[#FFA500]/50 hover:bg-[#FFA500]/5 transition-all">
                <Mail size={20} />
              </a>
            </motion.div>
          </div>
          ...
          {/* === CENTER COLUMN === */}
          <div className="lg:col-span-6 h-full flex flex-col items-center justify-center order-1 lg:order-2 relative">

            {/* Headline */}
            <motion.h1 variants={itemAnim} className="text-5xl md:text-7xl xl:text-8xl font-black text-white text-center leading-[0.9] tracking-tighter mb-8 z-20 mix-blend-screen">
              NEELAY <br />
              <span className="relative z-10 inline-block">
                JAIN
                <svg className="absolute w-[105%] h-6 -bottom-2 -left-2 text-[#FFA500] -z-10" viewBox="0 0 100 20" preserveAspectRatio="none">
            ...
            {/* Image */}
            <motion.div variants={itemAnim} className="relative w-full max-w-[400px] h-[45vh] lg:h-[55vh] z-10">
              ...
              <motion.div animate={{ y: [0, -6, 0] }} transition={{ repeat: Infinity, duration: 5, ease: "easeInOut" }} className="absolute bottom-8 -left-8 bg-[#000]/80 backdrop-blur-md border border-[#333] px-4 py-3 rounded-lg flex items-center gap-3 z-30">
          ...
          {/* === RIGHT COLUMN === */}
          <div className="lg:col-span-3 flex flex-col justify-center h-full gap-6 order-3 lg:order-3">

            {/* Tech Stack */}
            <motion.div variants={itemAnim} className="flex flex-wrap justify-center lg:justify-end gap-2">
